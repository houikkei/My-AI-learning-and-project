...
a3=pd.read_csv('点赞量中等的评论.csv',encoding='utf_8_sig')

del a3['voteup_count']
del a3['headline']
del a3['created_time']
del a3['updated_time']
del a3['comment_count']
del a3['thanks_count']
del a3['label']
del a3['gender']
a3 = pd.DataFrame(a3, columns=['content'])
a3.to_csv("a3.txt",encoding='utf_8_sig')
...
with open(r"a3.txt", "w", encoding='utf-8') as f:
    f.write(string)
    f.close()
## 设置禁用词
stopwords=set()
